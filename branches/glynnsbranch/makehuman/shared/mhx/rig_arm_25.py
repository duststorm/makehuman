...
ArmArmature = [
    ...
    # Arm deform
    #('UpArmRot_L',        0, 'UpArm_L', F_WIR, L_TWEAK, NoBB),
    ('DfmUpArm_L',        0, 'UpArm_L', F_DEF, L_DMAIN, NoBB),
    ...
    #('UpArmRot_R',        0, 'UpArm_R', F_WIR, L_TWEAK, NoBB),
    ('DfmUpArm_R',        0, 'UpArm_R', F_DEF, L_DMAIN, NoBB),
