...
class BackgroundTaskView(gui3d.TaskView):
    ...
    def __init__(self, category):
        gui3d.TaskView.__init__(self, category, 'Background', category.app.getThemeResource('images', 'button_background.png'), category.app.getThemeResource('images',
                                'button_background_on.png'))
