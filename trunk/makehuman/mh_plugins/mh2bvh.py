...
Module File Location:        mh_plugins/mh2bvh.py                                          
...
skeletonRoot = Joint("joint-pelvis",
                [Joint("joint-spine3",
                  [Joint("joint-spine2",
                    [Joint("joint-spine1",
                      [Joint("joint-neck",
                       ...
                       Joint("r-clavicle",
                        [Joint("joint-r-shoulder",
                          [Joint("joint-r-elbow",
                            [Joint("joint-r-hand",
                              [Joint("joint-r-finger-1-1",
                                [Joint("joint-r-finger-1-2",
                                  [Joint("joint-r-finger-1-3", [])
                                  ])
                                ]),
                               Joint("joint-r-finger-2-1", 
                                [Joint("joint-r-finger-2-2",
                                  [Joint("joint-r-finger-2-3", [])
                                  ])
                                ]),
                               Joint("joint-r-finger-3-1", 
                                [Joint("joint-r-finger-3-2",
                                  [Joint("joint-r-finger-3-3", [])
                                  ])
                                ]),
                               Joint("joint-r-finger-4-1", 
                                [Joint("joint-r-finger-4-2",
                                  [Joint("joint-r-finger-4-3", [])
                                  ])
                                ]),
                               Joint("joint-r-finger-5-1", 
                                [Joint("joint-r-finger-5-2",
                                  [Joint("joint-r-finger-5-3", [])
                                  ])
                                ])
                              ])
                            ])
                        ...
                        [Joint("joint-l-shoulder",
                          [Joint("joint-l-elbow",
                            [Joint("joint-l-hand",
                              [Joint("joint-l-finger-1-1",
                                [Joint("joint-l-finger-1-2",
                                  [Joint("joint-l-finger-1-3", [])
                                  ])
                                ]),
                               Joint("joint-l-finger-2-1", 
                                [Joint("joint-l-finger-2-2",
                                  [Joint("joint-l-finger-2-3", [])
                                  ])
                                ]),
                               Joint("joint-l-finger-3-1", 
                                [Joint("joint-l-finger-3-2",
                                  [Joint("joint-l-finger-3-3", [])
                                  ])
                                ]),
                               Joint("joint-l-finger-4-1", 
                                [Joint("joint-l-finger-4-2",
                                  [Joint("joint-l-finger-4-3", [])
                                  ])
                                ]),
                               Joint("joint-l-finger-5-1", 
                                [Joint("joint-l-finger-5-2",
                 ...
                 Joint("joint-r-upper-leg",
                  [Joint("joint-r-knee",
                    [Joint("joint-r-ankle",
                      [Joint("joint-r-toe-1-1",
                        [Joint("joint-r-toe-1-2", [])
                        ]),
                       Joint("joint-r-toe-2-1", 
                        [Joint("joint-r-toe-2-2",
                          [Joint("joint-r-toe-2-3", [])
                          ])
                        ]),
                       Joint("joint-r-toe-3-1", 
                        [Joint("joint-r-toe-3-2",
                          [Joint("joint-r-toe-3-3", [])
                          ])
                        ]),
                       Joint("joint-r-toe-4-1", 
                        [Joint("joint-r-toe-4-2",
                          [Joint("joint-r-toe-4-3", [])
                          ])
                        ]),
                       Joint("joint-r-toe-5-1", 
                        [Joint("joint-r-toe-5-2",
                          [Joint("joint-r-toe-5-3", [])
                          ])
                        ])
                      ])
                    ])
                  ]),
                 Joint("joint-l-upper-leg",
                  [Joint("joint-l-knee",
                    [Joint("joint-l-ankle",
                      [Joint("joint-l-toe-1-1",
                        [Joint("joint-l-toe-1-2", [])
                        ]),
                       Joint("joint-l-toe-2-1", 
                        [Joint("joint-l-toe-2-2",
                          [Joint("joint-l-toe-2-3", [])
                          ])
                        ]),
                       Joint("joint-l-toe-3-1", 
                        [Joint("joint-l-toe-3-2",
                          [Joint("joint-l-toe-3-3", [])
                          ])
                        ]),
                       Joint("joint-l-toe-4-1", 
                        [Joint("joint-l-toe-4-2",
                          [Joint("joint-l-toe-4-3", [])
                          ])
                        ]),
                       Joint("joint-l-toe-5-1", 
                        [Joint("joint-l-toe-5-2",
                          [Joint("joint-l-toe-5-3", [])
                          ])
                        ])
                      ])
                    ])
