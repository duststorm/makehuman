    ...
    def applyAllTargets(self, progressCallback = None):
        ...
        **Parameters:** None.
        ...
        for i in xrange(1, 9):
          ...
          detailTargets["data/targets/details/female-child-flaccid-light-cup%i-firmness0.target"%(i)] = self.flaccidVal*self.underweightVal*self.childVal*self.femaleVal*(1.0-self.breastFirmness)*breastCupValues[i]
          detailTargets["data/targets/details/female-child-flaccid-light-cup%i-firmness1.target"%(i)] = self.flaccidVal*self.underweightVal*self.childVal*self.femaleVal*self.breastFirmness*breastCupValues[i]
