...
joints = ['pelvis', 'spine3', 'spine2', 'spine1', 'neck', 'head', 'mouth', 'l-eye', 'r-eye', 'r-clavicle', 'r-shoulder', 'r-elbow', 'r-hand', 'r-finger-1-1',
          'r-finger-1-2', 'r-finger-1-3', 'r-finger-2-1', 'r-finger-2-2', 'r-finger-2-3', 'r-finger-3-1', 'r-finger-3-2', 'r-finger-3-3', 'r-finger-4-1', 'r-finger-4-2',
          'r-finger-4-3', 'r-finger-5-1', 'r-finger-5-2', 'r-finger-5-3', 'l-clavicle', 'l-shoulder', 'l-elbow', 'l-hand', 'l-finger-1-1', 'l-finger-1-2', 'l-finger-1-3'
          , 'l-finger-2-1', 'l-finger-2-2', 'l-finger-2-3', 'l-finger-3-1', 'l-finger-3-2', 'l-finger-3-3', 'l-finger-4-1', 'l-finger-4-2', 'l-finger-4-3', 'l-finger-5-1'
          , 'l-finger-5-2', 'l-finger-5-3', 'r-upper-leg', 'r-knee', 'r-ankle', 'r-toe-1-1', 'r-toe-1-2', 'r-toe-2-1', 'r-toe-2-2', 'r-toe-2-3', 'r-toe-3-1', 'r-toe-3-2'
          , 'r-toe-3-3', 'r-toe-4-1', 'r-toe-4-2', 'r-toe-4-3', 'r-toe-5-1', 'r-toe-5-2', 'r-toe-5-3', 'l-upper-leg', 'l-knee', 'l-ankle', 'l-toe-1-1', 'l-toe-1-2',
          'l-toe-2-1', 'l-toe-2-2', 'l-toe-2-3', 'l-toe-3-1', 'l-toe-3-2', 'l-toe-3-3', 'l-toe-4-1', 'l-toe-4-2', 'l-toe-4-3', 'l-toe-5-1', 'l-toe-5-2', 'l-toe-5-3']
...
otherLocations = [('head-end', 'neck', 'head', 1.0), ('mouth-end', 'head', 'mouth', 0x0002), ('l-finger-1-end', 'l-finger-1-2', 'l-finger-1-3', 1.0), ('l-finger-2-end',
                  'l-finger-2-2', 'l-finger-2-3', 1.0), ('l-finger-3-end', 'l-finger-3-2', 'l-finger-3-3', 1.0), ('l-finger-4-end', 'l-finger-4-2', 'l-finger-4-3', 1.0),
                  ('l-finger-5-end', 'l-finger-5-2', 'l-finger-5-3', 1.0), ('r-finger-1-end', 'r-finger-1-2', 'r-finger-1-3', 1.0), ('r-finger-2-end', 'r-finger-2-2',
                  'r-finger-2-3', 1.0), ('r-finger-3-end', 'r-finger-3-2', 'r-finger-3-3', 1.0), ('r-finger-4-end', 'r-finger-4-2', 'r-finger-4-3', 1.0),
                  ('r-finger-5-end', 'r-finger-5-2', 'r-finger-5-3', 1.0), ('l-toe-1-end', 'l-toe-1-1', 'l-toe-1-2', 1.0), ('l-toe-2-end', 'l-toe-2-2', 'l-toe-2-3',
                  1.0), ('l-toe-3-end', 'l-toe-3-2', 'l-toe-3-3', 1.0), ('l-toe-4-end', 'l-toe-4-2', 'l-toe-4-3', 1.0), ('l-toe-5-end', 'l-toe-5-2', 'l-toe-5-3', 1.0),
                  ('r-toe-1-end', 'r-toe-1-1', 'r-toe-1-2', 1.0), ('r-toe-2-end', 'r-toe-2-2', 'r-toe-2-3', 1.0), ('r-toe-3-end', 'r-toe-3-2', 'r-toe-3-3', 1.0),
                  ('r-toe-4-end', 'r-toe-4-2', 'r-toe-4-3', 1.0), ('r-toe-5-end', 'r-toe-5-2', 'r-toe-5-3', 1.0), ('r-toe-end', 'r-toe-3-1', 'r-toe-3-3', 1.0),
                  ('l-toe-end', 'l-toe-3-1', 'l-toe-3-3', 1.0), ('l-knee-target', 'l-upper-leg', 'l-knee', 0.2), ('l-elbow-target', 'l-shoulder', 'l-elbow', 0.2),
                  ('r-knee-target', 'r-upper-leg', 'r-knee', 0.2), ('r-elbow-target', 'r-shoulder', 'r-elbow', 0.2)]

#
# ....The midpoints between two locations
#

midLocations = [('mid-eyes', 'l-eye', 'r-eye', 0.5), ('mid-feet', 'l-toe-1-1', 'r-toe-1-1', 0.5), ('l-clavicle-pt2', 'l-clavicle', 'l-shoulder', 0.5), ('l-uparm-pt1',
                'l-shoulder', 'l-elbow', 0.5), ('l-uparm-pt2', 'l-shoulder', 'l-elbow', 0.7), ('l-loarm-pt1', 'l-elbow', 'l-hand', 0.3), ('l-loarm-pt2', 'l-elbow',
                'l-hand', 0.7), ('l-upleg-pt1', 'l-upper-leg', 'l-knee', 0.3), ('l-upleg-pt2', 'l-upper-leg', 'l-knee', 0.7), ('l-loleg-pt1', 'l-knee', 'l-ankle', 0.3),
                ('l-loleg-pt2', 'l-knee', 'l-ankle', 0.7), ('r-clavicle-pt2', 'r-clavicle', 'r-shoulder', 0.5), ('r-uparm-pt1', 'r-shoulder', 'r-elbow', 0.5),
                ('r-uparm-pt2', 'r-shoulder', 'r-elbow', 0.7), ('r-loarm-pt1', 'r-elbow', 'r-hand', 0.3), ('r-loarm-pt2', 'r-elbow', 'r-hand', 0.7), ('r-upleg-pt1',
                'r-upper-leg', 'r-knee', 0.3), ('r-upleg-pt2', 'r-upper-leg', 'r-knee', 0.7), ('r-loleg-pt1', 'r-knee', 'r-ankle', 0.3), ('r-loleg-pt2', 'r-knee',
                'r-ankle', 0.7)]
...
vertLocations = [('chest-front', 7292), ('jaw-tip', 8162), ('tounge-tip', 8049), ('tounge-mid', 8103), ('tounge-root', 8099), ('l-upLid', 12630), ('l-loLid', 12594),
                 ('r-upLid', 2442), ('r-loLid', 2520)]
...
armature = [  # Face representation
    ...
    ('LegCtrl_L', 'Root', 'r-ankle', [0, -1, 0], 'r-ankle', [0, -1, -0x0002], F_NODEF, L_LEGIK, None, 0),
    ...
    ('LegCtrl_R', 'Root', 'l-ankle', [0, -1, 0], 'l-ankle', [0, -1, -0x0002], F_NODEF, L_LEGIK, None, 0),
    ...
    ('PBrow_R', 'PFace', 'origin', [-0x0002 * dx, 4 * dx, 0], 'origin', [-0x0002 * dx, 4 * dx, dz], F_NODEF, L_PANEL, None, 0),
    ('PBrow_L', 'PFace', 'origin', [0x0002 * dx, 4 * dx, 0], 'origin', [0x0002 * dx, 4 * dx, dz], F_NODEF, L_PANEL, None, 0),
    ('PBrows', 'PFace', 'origin', [0, 4 * dx, 0], 'origin', [0, 4 * dx, dz], F_NODEF, L_PANEL, None, 0),
    ('PUpLid_R', 'PFace', 'origin', [-0x0002 * dx, 2.8 * dx, 0], 'origin', [-0x0002 * dx, 2.8 * dx, dz], F_NODEF, L_PANEL, None, 0),
    ('PUpLid_L', 'PFace', 'origin', [0x0002 * dx, 2.8 * dx, 0], 'origin', [0x0002 * dx, 2.8 * dx, dz], F_NODEF, L_PANEL, None, 0),
    ('PLoLid_R', 'PFace', 'origin', [-0x0002 * dx, 1 * dx, 0], 'origin', [-0x0002 * dx, 1 * dx, dz], F_NODEF, L_PANEL, None, 0),
    ('PLoLid_L', 'PFace', 'origin', [0x0002 * dx, 1 * dx, 0], 'origin', [0x0002 * dx, 1 * dx, dz], F_NODEF, L_PANEL, None, 0),
    ('PCheek_R', 'PFace', 'origin', [-0x0002 * dx, 0, 0], 'origin', [-0x0002 * dx, 0, dz], F_NODEF, L_PANEL, None, 0),
    ('PCheek_L', 'PFace', 'origin', [0x0002 * dx, 0, 0], 'origin', [0x0002 * dx, 0, dz], F_NODEF, L_PANEL, None, 0),
    ...
    ('PArmIK_R', 'PFace', 'origin', [-1.1, 0x0002, 0], 'origin', [-1.1, 0x0002, dz], F_NODEF, L_PANEL, None, 0),
    ('PArmIK_L', 'PFace', 'origin', [0.1, 0x0002, 0], 'origin', [0.1, 0x0002, dz], F_NODEF, L_PANEL, None, 0),
...
boneRoll = {
    ...
    'Finger-3-Pole_L': (-3, -4),
    'Finger-3-Pole_R': (3, 4),
    'Finger-3_L': (0x0002, 94),
    'Finger-3_R': (-0x0002, -94),
    'Finger-4-1_L': (5, 94),
    'Finger-4-1_R': (-5, -94),
    'Finger-4-2_L': (0, 93),
    'Finger-4-2_R': (0, -93),
    ...
    'Finger-4-Pole_L': (-3, -4),
    'Finger-4-Pole_R': (3, 4),
    'Finger-4_L': (0x0002, 94),
    'Finger-4_R': (-0x0002, -94),
    'Finger-5-1_L': (7, 94),
    'Finger-5-1_R': (-7, -94),
    'Finger-5-2_L': (3, 93),
    'Finger-5-2_R': (-3, -93),
    ...
    'Toe-1-2_L': (5, 139),
    'Toe-1-2_R': (-5, -139),
    'Toe-2-1_L': (0x0008, 103),
    'Toe-2-1_R': (-0x0008, -103),
    'Toe-2-2_L': (4, -29),
    'Toe-2-2_R': (-4, 29),
    'Toe-2-3_L': (4, -29),
    'Toe-2-3_R': (-4, 29),
...
Bone = 0
Obj = 1
constraints = [('Stomach', 'LIMITROT', 1.0, 'None', None, 5, (0, 0, 0, 0, 0, 0)), ('Stomach', 'STRETCHTO', 1.0, 'Hips', None, '', 0), ('LoLegIK_L', 'IKSOLVER', 1.0,
               'Ankle_L', None, 0x0002, Bone), ('LoLeg_L', 'COPYROT', 1.0, 'LoLegIK_L', 'PLegIK_L', 7, 0), ('Foot_L', 'IKSOLVER', 1.0, 'FootIK_L', 'PLegIK_L', 1, Bone),
               ('Toe_L', 'COPYROT', 1.0, 'ToeIK_L', 'PLegIK_L', 7, 0), ('UpLegIK_L', 'IKSOLVER', 1.0, 'KneeIK_L', None, 1, Bone), ('UpLeg_L', 'COPYROT', 1.0, 'UpLegIK_L'
               , 'PLegIK_L', 7, 0), ('LegCtrl_L', 'LIMITDIST', 1.0, 'Hip_L', None, '', 0), ('KneeIK_L', 'LIMITDIST', 1.0, 'Hip_L', None, '', 0), ('UpLegTwist_L',
               'IKSOLVER', 1.0, 'LoLeg_L', None, 1, Bone), ('LoLegIK_R', 'IKSOLVER', 1.0, 'Ankle_R', None, 0x0002, Bone), ('LoLeg_R', 'COPYROT', 1.0, 'LoLegIK_R',
               'PLegIK_R', 7, 0), ('Foot_R', 'IKSOLVER', 1.0, 'FootIK_R', 'PLegIK_R', 1, Bone), ('Toe_R', 'COPYROT', 1.0, 'ToeIK_R', 'PLegIK_R', 7, 0), ('UpLegIK_R',
               'IKSOLVER', 1.0, 'KneeIK_R', None, 1, Bone), ('UpLeg_R', 'COPYROT', 1.0, 'UpLegIK_R', 'PLegIK_R', 7, 0), ('LegCtrl_R', 'LIMITDIST', 1.0, 'Hip_R', None, ''
               , 0), ('KneeIK_R', 'LIMITDIST', 1.0, 'Hip_R', None, '', 0), ('UpLegTwist_R', 'IKSOLVER', 1.0, 'LoLeg_R', None, 1, Bone), ('LoArmIK_L', 'IKSOLVER', 1.0,
               'HandIK_L', None, 0x0002, Bone), ('LoArm_L', 'COPYROT', 1.0, 'LoArmIK_L', 'PArmIK_L', 7, 0), ('UpArmIK_L', 'IKSOLVER', 1.0, 'ElbowIK_L', None, 1, Bone),
               ('UpArm_L', 'COPYROT', 1.0, 'UpArmIK_L', 'PArmIK_L', 7, 0), ('Hand_L', 'COPYROT', 1.0, 'HandIK_L', 'PArmIK_L', 7, 0), ('HandIK_L', 'LIMITDIST', 1.0,
               'Clavicle_L', None, '', 0), ('ElbowIK_L', 'LIMITDIST', 1.0, 'Clavicle_L', None, '', 0), ('LoArmIK_R', 'IKSOLVER', 1.0, 'HandIK_R', None, 0x0002, Bone),
               ('LoArm_R', 'COPYROT', 1.0, 'LoArmIK_R', 'PArmIK_R', 7, 0), ('UpArmIK_R', 'IKSOLVER', 1.0, 'ElbowIK_R', None, 1, Bone), ('UpArm_R', 'COPYROT', 1.0,
               'UpArmIK_R', 'PArmIK_R', 7, 0), ('Hand_R', 'COPYROT', 1.0, 'HandIK_R', 'PArmIK_R', 7, 0), ('HandIK_R', 'LIMITDIST', 1.0, 'Clavicle_R', None, '', 0),
               ('ElbowIK_R', 'LIMITDIST', 1.0, 'Clavicle_R', None, '', 0), ('UpArmTwist_L', 'IKSOLVER', 1.0, 'LoArm_L', None, 1, Bone), ('LoArmTwist_L', 'IKSOLVER', 1.0,
               'Hand_L', None, 1, Bone), ('UpArmTwist_R', 'IKSOLVER', 1.0, 'LoArm_R', None, 1, Bone), ('LoArmTwist_R', 'IKSOLVER', 1.0, 'Hand_R', None, 1, Bone), ('Eye_R'
               , 'IKSOLVER', 1.0, 'Gaze_R', 'Gaze-switch', 1, Bone), ('Eye_L', 'IKSOLVER', 1.0, 'Gaze_L', 'Gaze-switch', 1, Bone), ('Finger-1-3_R', 'IKSOLVER', 1.0,
               'Finger-1-IK_R', 'FingerIK_L', 3, Bone), ('Finger-2-3_R', 'IKSOLVER', 1.0, 'Finger-2-IK_R', 'FingerIK_L', 3, Bone), ('Finger-3-3_R', 'IKSOLVER', 1.0,
               'Finger-3-IK_R', 'FingerIK_L', 3, Bone), ('Finger-4-3_R', 'IKSOLVER', 1.0, 'Finger-4-IK_R', 'FingerIK_L', 3, Bone), ('Finger-5-3_R', 'IKSOLVER', 1.0,
               'Finger-5-IK_R', 'FingerIK_L', 3, Bone), ('Finger-1-3_L', 'IKSOLVER', 1.0, 'Finger-1-IK_L', 'FingerIK_L', 3, Bone), ('Finger-2-3_L', 'IKSOLVER', 1.0,
               'Finger-2-IK_L', 'FingerIK_L', 3, Bone), ('Finger-3-3_L', 'IKSOLVER', 1.0, 'Finger-3-IK_L', 'FingerIK_L', 3, Bone), ('Finger-4-3_L', 'IKSOLVER', 1.0,
               'Finger-4-IK_L', 'FingerIK_L', 3, Bone), ('Finger-5-3_L', 'IKSOLVER', 1.0, 'Finger-5-IK_L', 'FingerIK_L', 3, Bone), ('Finger-1-1_R', 'IKSOLVER', 1.0,
               'Finger-1-Pole_R', 'FingerIK_L', 1, Bone), ('Finger-2-1_R', 'IKSOLVER', 1.0, 'Finger-2-Pole_R', 'FingerIK_L', 1, Bone), ('Finger-3-1_R', 'IKSOLVER', 1.0,
               'Finger-3-Pole_R', 'FingerIK_L', 1, Bone), ('Finger-4-1_R', 'IKSOLVER', 1.0, 'Finger-4-Pole_R', 'FingerIK_L', 1, Bone), ('Finger-5-1_R', 'IKSOLVER', 1.0,
               'Finger-5-Pole_R', 'FingerIK_L', 1, Bone), ('Finger-1-1_L', 'IKSOLVER', 1.0, 'Finger-1-Pole_L', 'FingerIK_L', 1, Bone), ('Finger-2-1_L', 'IKSOLVER', 1.0,
               'Finger-2-Pole_L', 'FingerIK_L', 1, Bone), ('Finger-3-1_L', 'IKSOLVER', 1.0, 'Finger-3-Pole_L', 'FingerIK_L', 1, Bone), ('Finger-4-1_L', 'IKSOLVER', 1.0,
               'Finger-4-Pole_L', 'FingerIK_L', 1, Bone), ('Finger-5-1_L', 'IKSOLVER', 1.0, 'Finger-5-Pole_L', 'FingerIK_L', 1, Bone), ('PArmIK_L', 'LIMITLOC', 1.0,
               'None', None, 0x3f, (0, 1, 0, 0, 0, 0)), ('PArmIK_R', 'LIMITLOC', 1.0, 'None', None, 0x3f, (0, 1, 0, 0, 0, 0)), ('PLegIK_L', 'LIMITLOC', 1.0, 'None',
               None, 0x3f, (0, 1, 0, 0, 0, 0)), ('PLegIK_R', 'LIMITLOC', 1.0, 'None', None, 0x3f, (0, 1, 0, 0, 0, 0))]  # ("Foot_L" , "COPYROT", 1.0, "FootIK_L", "PLegIK_L", 0x12, 0),
    ...
    for (bone, par, hjoint, hoffs, tjoint, toffs, flags, layers, dispOb, ikFlags) in armature:
        ...
        for (bone1, type, infl, target, driver, arg1, arg2) in constraints:
            if bone == bone1:
                ...
                if type == 'IKSOLVER':
                    if arg2 == Bone:
                        fp.write("\t\t\tCHAINLEN	int %d ; \n" % arg1 + "\t\t\tTARGET	obj HumanRig ; \n" + "\t\t\tBONE	str %s ; \n" % target)
                    else:
                        fp.write("\t\t\tCHAINLEN	int %d ; \n" % arg1 + "\t\t\tTARGET	obj %s ; \n" % target)
                        smash = 'influence=%4.2f' % infl
                elif type == 'COPYROT':

                    fp.write("\t\t\tTARGET	obj HumanRig ;\n" + "\t\t\tBONE	str %s ; \n" % target + "\t\t\tCOPY	hex %x ;\n" % arg1)
                elif type == 'COPYLOC':
                    ...
                    fp.write("\t\t\tLIMIT	hex %x ;\n" % arg1 + '\t\t\tOWNERSPACE       hex 1 ;\n' + '\t\t\tXMIN       float %g ; \n' % xmin
                              + '\t\t\tXMAX       float %g ; \n' % xmax + '\t\t\tYMIN       float %g ; \n' % ymin + '\t\t\tYMAX       float %g ; \n' % ymax
                              + '\t\t\tZMIN       float %g ; \n' % zmin + '\t\t\tZMAX       float %g ; \n' % zmax)
                elif type == 'LIMITLOC':
...
ConstraintTypeTable = {'COPYLOC': 'COPY_LOCATION', 'COPYROT': 'COPY_ROTATION', 'COPYSCALE': 'COPY_SCALE', 'LIMITDIST': 'LIMIT_DISTANCE', 'LIMITLOC': 'LIMIT_LOCATION',
                       'LIMITROT': 'LIMIT_ROTATION', 'LIMITSCALE': 'LIMIT_SCALE', 'TRANSFORM': 'TRANSFORM', 'CLAMPTO': 'CLAMP_TO', 'DAMPED_TRACK': 'DAMPED_TRACK',
                       'IKSOLVER': 'IK', 'LOCKED_TRACK': 'LOCKED_TRACK', 'SPLINE_IK': 'SPLINE_IK', 'STRETCHTO': 'STRETCH_TO', 'TRACKTO': 'TRACK_TO', 'ACTION': 'ACTION',
                       'CHILDOF': 'CHILD_OF', 'FLOOR': 'FLOOR', 'FOLLOWPATH': 'FOLLOW_PATH', 'SHRINKWRAP': 'SHRINKWRAP'}
        ...
        for (bone1, type, infl, target, driver, arg1, arg2) in constraints:
            if bone == bone1:
                ...
                if type == 'IKSOLVER':
                    ...
                    (xmin, xmax, ymin, ymax, zmin, zmax) = arg2
                    fp.write("\t\t\tLIMIT	hex %x ;\n" % arg1 + "\t\t\towner_space	str LOCAL ;\n" + '\t\t\tminimum_x       float %g ; \n' % xmin
                              + '\t\t\tmaximum_x       float %g ; \n' % xmax + '\t\t\tminimum_y       float %g ; \n' % ymin + '\t\t\tmaximum_y       float %g ; \n' % ymax
                              + '\t\t\tminimum_z       float %g ; \n' % zmin + '\t\t\tmaximum_z       float %g ; \n' % zmax)
                elif type == 'LIMITLOC':
                    (xmin, xmax, ymin, ymax, zmin, zmax) = arg2
                    fp.write("\t\t\tLIMIT	hex %x ;\n" % arg1 + '\t\t\towner_space     str LOCAL ;\n' + '\t\t\tminimum_x       float %g ; \n' % xmin
                              + '\t\t\tmaximum_x       float %g ; \n' % xmax + '\t\t\tminimum_y       float %g ; \n' % ymin + '\t\t\tmaximum_y       float %g ; \n' % ymax
...
def setupBones(obj):
    ...
    setupLocations(obj)
    locations['origin'] = (-0x0002, 10.0, 0.0)
    boneHead = {}
    boneTail = {}
    for (bone, par, hjoint, hoffs, tjoint, toffs, flags, layers, dispOb, ikFlags) in armature:
        if hoffs:
