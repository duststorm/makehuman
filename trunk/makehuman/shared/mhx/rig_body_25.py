...
BodyArmature = [
    ...
    ('MasterHips',         0, None, F_WIR+F_HID, L_MAIN, NoBB),
    ('MasterNeck',         0, None, F_WIR+F_HID, L_MAIN, NoBB),

    ('Root',               0, Master, F_WIR, L_MAIN+L_SPINEFK+L_SPINEIK, NoBB),
    ('BendRoot',           0, 'Root', 0, L_HELP, NoBB),
    ('Hips',               0, 'Root', F_WIR, L_SPINEFK+L_SPINEIK, NoBB),

    ('Spine1',             0, 'Root', F_WIR, L_SPINEFK, NoBB),
    ('Spine2',             0, 'Spine1', F_WIR, L_SPINEFK, NoBB),
    ('Spine3',             0, 'Spine2', F_WIR, L_SPINEFK, NoBB),

    ('Shoulders',          0, 'Root', F_WIR, L_SPINEIK, NoBB),
    ('SpineBender',        0, 'Root', 0, L_HELP, NoBB),

    ('Neck',               0, 'Spine3', F_WIR, L_SPINEIK+L_SPINEFK+L_HEAD, NoBB),
    ('Head',               0, 'Neck', F_WIR, L_SPINEIK+L_SPINEFK+L_HEAD, NoBB),

    ('DfmHips',            0, 'Root', F_DEF, L_DMAIN, NoBB),
    ('DfmSpine1',          0, 'Root', F_DEF+F_CON, L_DMAIN, (1,1,3) ),
    ('DfmSpine2',          0, 'Spine1', F_DEF+F_CON, L_DMAIN, (1,1,3) ),
    ('DfmSpine3',          0, 'Spine2', F_DEF+F_CON, L_DMAIN, (1,1,3) ),
    ('DfmNeck',            0, 'Spine3', F_DEF+F_CON, L_DMAIN, (1,1,3) ),
    ('DfmHead',            0, 'Neck', F_DEF+F_CON, L_DMAIN, NoBB),

    ('DfmRib',             0, 'Spine3', F_DEF, L_DMAIN, NoBB),
    ('RibTarget',          0, 'Spine2', 0, L_HELP, NoBB),
    ('DfmStomach',         0, 'DfmRib', F_DEF+F_CON, L_DMAIN, NoBB),
    ('HipBone',            0, 'Hips', 0, L_HELP, NoBB),

    ('Breast_L',           -45*D, 'DfmRib', F_DEF, L_DEF, NoBB),
    ('Breast_R',           45*D, 'DfmRib', F_DEF, L_DEF, NoBB),
    ('Breathe',            0, 'DfmRib', F_WIR, L_TORSO, NoBB),

    ('Penis',              0, 'Hips', F_DEF, L_TORSO, (1,5,1) ),
    ('Scrotum',            0, 'Hips', F_DEF, L_TORSO, NoBB),
]
